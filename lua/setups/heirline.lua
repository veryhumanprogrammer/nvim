...
Left = utils.surround({ "", "" }, "bright_bg", { ViMode, Diagnostics })
Middle = utils.surround({ "", "" }, "bright_bg", { LSPActive, FileNameBlock })
Right = utils.surround({ "", "" }, "bright_bg", { Git, Space, Ruler, Space, ScrollBar })
